...
function checkStreak(){
  chrome.storage.local.get(currentDomain, function(result) {
    ...
    if(streakDetails == null || currentDomain.includes(null)){
      ...
      [streakLen, maxStreak, lastVisit] = JSON.parse(streakDetails);
      var differenceInDays = dateNum - lastVisit;
      if(differenceInDays == 0){streakLen += 0;}
